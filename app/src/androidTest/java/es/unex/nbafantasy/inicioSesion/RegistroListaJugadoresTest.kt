...
class RegistroListaJugadoresTest {
    ...
    @Test
    fun registroListaJugadoresTest() {
        ...
        val bottomNavigationItemView = onView(
            allOf(
                withId(R.id.listaJugadoresFragment), withContentDescription("Jugadores"),
                childAtPosition(
                    childAtPosition(
